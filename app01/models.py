...
class Book(models.Model):
    ...
    publish_date = models.DateField(verbose_name="出版日期",null=True)
    price = models.DecimalField(max_digits=5,decimal_places=2,verbose_name="价格",null=True)

    # 与Publish检录一对多的关系，外键字段建立在多的一方
    publish = models.ForeignKey(to="Publish",to_field="nid",on_delete=models.CASCADE,verbose_name="出版社",null=True)
    # 与Author表建立多对多的关系，ManyToManyField可以建在两个模型中的任意一个，自动创建第三张表
    authors = models.ManyToManyField(to='Author',verbose_name="作者",null=True)
